      ...
      <Dialog open={showHelpPopup} onOpenChange={setShowHelpPopup}>
        <DialogContent className="w-full h-[80vh] max-w-md mx-auto overflow-y-auto flex flex-col">
          ...
          <div className="mt-4 space-y-4 flex-grow overflow-y-auto">
            ...
            <div>
              <p className="font-bold mb-2">勝手に増えるお金を増やそう！</p>
              <ul className="list-disc pl-5 space-y-2">
                <li>お金ノートにお金をためたまま日曜日になると、ちょっとだけお金が増えます。</li>
                <li>また次の日曜には、先週よりちょっとだけ多く増えます。</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>お仕事の報酬は、１週間に１回日曜日にもらえます。（変更できます）</li>
                <li>いつ、どれくらいお仕事をやるのかはお家の人と相談しよう。</li>
                <li>お仕事がなかなかできないときは、相談して減らしてもらおう。</li>
                <li>いつものお仕事の他に仕事がしたければ、クエストボードをチェックしてね。</li>
                <li>クエストの報酬はその日のうちにもらえます。</li>
                <li>クエストをクリアしたら、お家の人に言ってください。</li>
              </ul>
            </div>
          </div>
        </DialogContent>
